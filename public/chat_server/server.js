...
server.listen(6660, '166.70.53.122', function() {
...
io.sockets.on('connection', function(socket) {
   ...
   socket.on('disconnect', function(data){
       ...
       if(count == 1) {
           //Send chat_logout request to whereweallmeet.com using needle module
           needle.post('166.70.53.122/base/chat_logout', {username:  socket.nickname},
