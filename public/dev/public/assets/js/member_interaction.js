$(document).ready(function() {
    ...
    $("div.profile-sub-menu a#send-message, div.profile-sub-menu a#send-chat,nav#public-profile-nav a#send-a-hello,nav#public-profile-nav a#send-favorite, nav#public-profile-nav a#refer-a-friend").showUpgradeDialog();
    $("nav#public-profile-nav a#book-me,nav#public-profile-nav a#report-me,nav#public-profile-nav a#refer-me").showUpgradeDialog();


    $("a.send-message-icon,a.send-chat-request,p.icons a.send-hello-icon,p.icons a.save-profile-icon").showInteractionConfirmationDialog();
