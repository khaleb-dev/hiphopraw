...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="container" >
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php"><?php echo Asset::img('pages/home2/clogo.jpg'); ?> </a>
        </div>
        <div class="hidden-md-block hidden-lg-block header-clr"></div>
        <div class="col-md-7 header-link">
            <p>Join <span class="light-blue">Where</span><span class="pink">We</span><span class="light-grn">All</span><span class="yellow">Meet</span>.com & Find Your Club Adventures Tonight!</p>
        </div>
    </div> <!-- end container -->
    <!-- phone header
...
<div class="container-fluid row row1">
    <?php echo Asset::img('pages/home2/club-bg.jpg', array('class' => 'row-bg visible-md-block visible-lg-block')); ?>
    <div class="container">
...
<div class="container-fluid main">
    <div class="container">
        <h4 class="header-text" align="center">We have made it easy for our members to find the hottest club events around the country.</h4>
        <h2 class="secondary-text" align="center">join <span class="light-blue">Where</span><span class="pink">We</span><span class="light-grn">All</span><span class="yellow">Meet</span>.com and <span class="light-blue">Invite</span> your <span class="light-blue">Friends</span> to attend a club Event with you.
        </h2>
        <?php echo Asset::img('pages/home2/color.jpg', array('style' => 'width:100%;height:1px;')); ?>
        <div class="col-md-4">
            <h3 class="light-blue" align="center">CONCERTS</h3>
            <?php echo Asset::img('pages/home2/club01.jpg'); ?>
        </div>
        <div class="col-md-4">
            <h3 class="pink" align="center">FESTIVALS</h3>
            <?php echo Asset::img('pages/home2/club02.jpg'); ?>
        </div>
        <div class="col-md-4">
            <h3 class="light-grn" align="center">NIGHT CLUBS</h3>
            <?php echo Asset::img('pages/home2/club03.jpg'); ?>
        </div>
        <div class="clearfix"></div>
        <div class="signup">
            <p><span class="big-text">Sign Up Now and Take Advantage of these Exciting Club Events</span>
