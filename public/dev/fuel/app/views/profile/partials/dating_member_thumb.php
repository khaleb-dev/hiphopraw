...
<div class="member">
    ...
    <?php if ((Model_Friendship::are_friends($current_profile->id, $member['id']) AND $current_profile->id != $member['id']) || $current_profile->member_type_id == 2 || $current_profile->member_type_id == 3 || $current_user->group_id == 5):  ?>
