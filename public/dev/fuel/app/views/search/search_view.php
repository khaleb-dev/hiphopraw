...
<body>
<div id = "wrapper">
 <a href="allquicksearch"> <?php echo Asset::img('viewall.gif', array('id' => 'viewall'));?></a>
...
foreach($result['match2'] as  $value) {
		...
		echo "<ins id = 'state'>".$value['state']."</ins>";
		echo "<br>";
		echo Asset::img('mail.gif', array('id' => 'mail'));
		echo Asset::img('chat.gif', array('id' => 'chat'));
		echo Asset::img('favorite.gif', array('id' => 'favorite'));
		echo "</td>";
		$displaycounter++;
		$alldisplaycounter++;
		if($displaycounter == 4)
