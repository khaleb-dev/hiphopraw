...
class Quicksearchemptyhandlerpnone extends \Model {
	...
	public static function get_state($username,$password)
	{
		$id = Quicksearchemptyhandlerpnone::get_id($username, $password);
	...
	{
		$id = Quicksearchemptyhandlerpnone::get_profile_id($username, $password);
	...
	public static function get_yourmatchfirstage($username, $password,$chosen1,$chosen2,$chosen3,$chosen4,$chosen5,$myactual1,$myactual2,$myactual3,$myactual4,$myactual5,$actual11,$actual21,$actual31,$actual41,$actual51)
	{
		...
		$end = 99999999999;
		$topmatchchoice = Quicksearchemptyhandlerpnone::get_top_match_choice($username, $password);
		...
		if(!empty($chosen2) && empty($chosen1) && empty($chosen3) && empty($chosen4)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen3) && empty($chosen2) && empty($chosen1) && empty($chosen4)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen4) && empty($chosen2) && empty($chosen3) && empty($chosen1)  && empty($chosen5))
		{
			self::$counter = count($result);
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
		...
		if(!empty($chosen5) && empty($chosen2) && empty($chosen3) && empty($chosen4)  && empty($chosen1))
		{ 
			self::$counter = count($result);
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
		...
		if(!empty($chosen1) && !empty($chosen3) && empty($chosen2) && empty($chosen4)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen1) && !empty($chosen4) && empty($chosen3) && empty($chosen2)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen1) && !empty($chosen5) && empty($chosen3) && empty($chosen4)  && empty($chosen2))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen2) && !empty($chosen3) && empty($chosen1) && empty($chosen4)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen2) && !empty($chosen4) && empty($chosen1) && empty($chosen3)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen2) && !empty($chosen5) && empty($chosen1) && empty($chosen4)  && empty($chosen3))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen4) && !empty($chosen3) && empty($chosen1) && empty($chosen2)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen5) && !empty($chosen3) && empty($chosen1) && empty($chosen2)  && empty($chosen4))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(!empty($chosen4) && !empty($chosen5) && empty($chosen1) && empty($chosen2)  && empty($chosen3))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen3) && !empty($chosen4) && !empty($chosen1) && !empty($chosen2)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen4) && !empty($chosen3) && !empty($chosen1) && !empty($chosen5)  && empty($chosen2))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen1) && !empty($chosen3) && !empty($chosen4) && !empty($chosen2)  && empty($chosen5))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen4) && !empty($chosen3) && !empty($chosen5) && !empty($chosen2)  && empty($chosen1))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen3) && !empty($chosen5) && !empty($chosen4) && !empty($chosen2)  && empty($chosen1))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen2) && !empty($chosen3) && !empty($chosen4) && !empty($chosen5)  && empty($chosen1))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
		...
		if(empty($chosen3) && !empty($chosen4) && !empty($chosen1) && !empty($chosen5)  && empty($chosen2))
		{
			$result1 = DB::select('profiles.created_at','profiles.id','city','first_name','last_name','picture','profiles.user_id','state','username','group_id','email')
			->from('profiles')
			->join('users', 'right')->on('users.id', '=', 'profiles.user_id')
