<?php echo Form::open(array("id" => "message-form","action" => "messages/create")); ?>
    ...
    <p>
        ...
        <?php echo Form::input('title', Validation::instance()->validated('title')); ?>
        <span class="error with-margin"><?php echo Validation::instance()->error('title');?></span>
    </p>
    <p>
        <label for="description">Message:</label>
        <?php echo Form::textarea('detail', Validation::instance()->validated('detail')); ?>
