        ...
        <?php if($current_user) {?>
         ...
         <?php }else {?>
            ...
            <a href=" <?php echo Uri::create("pages/show") . "/" . $videoke->id; ?> ">   
                 <div class="real-video">
                 <?php echo Html::img($videoke->get_youtube_picture($videoke->user, $videoke->thumb_name), array("width" => "172", "height" => "114")); ?>
                    <span class="play">
                            <?php echo Asset::img("playIcon.png"); ?>
                    </span>
                </div>
     ...
     <?php }else {
        ...
        <?php if($videoke->youtube_link == 1) { ?>
            ...
            <div class="real-video">
                 ...
                 <?php echo Html::img($videoke->get_youtube_picture($videoke->user,$videoke->thumb_name), array("width" => "285", "height" => "200")); ?>
                        <span class="play">
                            <?php echo Asset::img("playIcon.png"); ?>
                          </span>
                 </div>
