<div class="other-videos" id="videoke_<?= $videoke->id ?>">
    ...
    ?>
    <div class="other-like-reader">
        <p> <?php echo Asset::img("user/like.png"); ?> <?php echo $videoke->likes; ?></p>
    </div>
    <div class="other-preview-reader">
        <p><?php echo $videoke->views; ?> <?php echo Asset::img("user/preview.png"); ?></p>
    </div>
    <span class="play">
            <?php echo Asset::img("playIcon.png"); ?>
    </span>
    <p class="other-model-name"><?php echo $videoke->title; ?></p>

    <p class="other-user-name-duration">
        <span class="other-user-name">By: <?php
