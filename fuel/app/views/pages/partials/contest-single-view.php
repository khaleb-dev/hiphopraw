<div class="videos" id="videoke_<?= $videoke->id ?>">
    ...
    <div class="share-reader">
        <p> <?php echo $videoke->likes; echo Asset::img("user/like.png"); ?> <?php // echo $videoke->share;  ?></p>
    </div>
    <div class="preview-reader1">
        <p><?php echo $videoke->views; ?> <?php echo Asset::img("user/preview.png"); ?></p>
    </div>
    <div class="model-name"><?php echo $videoke->title; ?></div>

    <div class="user-name-duration">
