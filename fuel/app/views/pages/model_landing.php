...
<title>Model Landing page</title>
<meta name="description" content="">
<meta name="viewport" content="width=device-width">

<!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

    <?php echo Asset::css('pages/model_landing.css'); ?>
...
<div id="notification-container">
	...
	<div class="container">
	   <div class="header">
			...
			<div class="logo" style=" padding-left:12%;"><?php echo Asset::img("model_landing/logo.png"); ?></div>
			<div class="center-top" style=" padding-left:2%;"><?php echo Asset::img("model_landing/center-top-logo.jpg", array('width'=>'350', 'height' => '50')); ?></div>
			<div class="win-right" style=" padding-left:7%;"><?php echo Asset::img("model_landing/win-right.png", array('width'=>'255', 'height' => '50')); ?></div>
		</div>
	</div>
	</header>
	...
	<div class="left-top-text" style=" padding-right:25%;">
	<h4>Create Your Profile & Gain Exposure</h4>
	</div>
	  
  <div class="follow-container">
	<div class="bg-model" >
	<div class="social-media"><?php echo Asset::img("model_landing/media.jpg", array('width'=>'80', 'height' => '80')); ?></div>
	</div>
	
<div class="follow-button">
 <div class="container" style=" padding-left:2%;">
 <div class="model-name"><strong>Elizabeth Velasquez</strong></div>  
...
<div class="transparent-bar" style=" padding-right:40%;">
 ...
 <p><h3>Are You an Elite Model?</h3>
...
<div class="signup-right">
	...
	<form class="sign-up-form" action="<?php echo Uri::create('pages/sign_up_model'); ?>"  method="post">
		<div class="col-md-12">
		...
		<h5><strong>Complete the fields below to create your profile & start Showcasing your elitenes today!</strong></h5>
			 ...
			 <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <input type="password" class="input-field password" id="password" name="password"  tabindex="1" placeholder="Password:">
                <span class="red" style="display: inline-block">&lowast;</span>
                <span class="error red empty">Please enter a password</span>
                <span class="error red too-long">Please enter less than 255 characters.</span>
              </div>
              <div class="form-group">
                <input type="password" class="input-field confirm_password" id="confirm_password" name="confirm_password"  tabindex="1" placeholder="Confirm:">
              	<span class="red" style="display: inline-block">&lowast;</span>
	...
	<div class="row4">
		...
		<div class="pc-section"  style="padding-left:6%;">
					<div class="image"><?php echo Asset::img("model_landing/desktop.jpg", array('width'=>'319', 'height' => '400')); ?></div>
	     </div>
...
<div class="row5">
	<div class="container">
		<div class="row" >
		<div class="follow-container-white" style="padding-top:10%;">
			<div class="left-top-text" style=" padding-right:25%;">
			<h4>Create Your Profile & Gain Exposure</h4>
			</div>
	<div class="mini-decor" style="padding-top:1%; padding-left:8%;">
	<div class="decoration"><?php echo Asset::img("model_landing/mini-decor-white.png", array('width'=>'50', 'height' => '10')); ?></div>
	</div>
  	...
  	<div class="container">
		...
		<div class="follow-button-middle">
 		<div class="follow-text-container">
 			<div class="model-name-white">
 
			<font color="black"><strong>Kiki Kayo</strong></font></div>  

			<div class="button-white" > <a href="#" class="col-md-12 btn btn-danger btn-md" style=" padding-right:0%;">FOLLOW</a>
	...
	<div class="container">
		...
		<div class="mobile-section" style="padding-left:12%;">
			...
			<?php echo Asset::img("model_landing/mob.jpg", array('width'=>'319', 'height' => '460')); ?></div>
