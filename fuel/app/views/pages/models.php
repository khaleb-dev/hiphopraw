...
<div id="models-container">
    <input type="hidden" id="page" value="MODELS" />
 ...
 <div class="home-white-wrapper">
    ...
    <div id="videos-view-more">
        <p  id = "view-more-anchor" url = "<?php echo Uri::create('pages/models_show_more'); ?>" data-page-no="2"><strong>VIEW MORE VIDEOS</strong></p>
    </div>
    <?php endif; ?>
    </div>
</div>
