...
<div id="home-container">
  ...
  <div class="home-white-wrapper">
    ...
    -->
      <h3>
          <?php echo Asset::img("nav-icons-red.png"); ?>
          Today's Videos
      </h3>
                        ...
                        <div id="home-banners-row">
                         <div id="banner-container">
                          <?php if(isset($first_left_banner)): ?>
                             <div id="banner-gitar">
                                <a href="<?php echo $first_left_banner->web_address; ?>" target="_blank"><?php echo Asset::img(Model_Banner::get_banner($first_left_banner),array("width" => "500", "height" => "216")) ?></a>
                            </div>
                             <?php endif; ?>
                        <?php if(isset($first_right_banner)): ?>
                                <div id="banner-coca">
                                <a href="<?php echo $first_right_banner->web_address; ?>" target="_blank"><?php echo Asset::img(Model_Banner::get_banner($first_right_banner),array("width" => "500", "height" => "216")) ?></a>
                                 </div>
                        <?php endif; ?>
                        <div class="clearfix"></div>
                         </div>
                ...
                $page_right_banner = Model_Banner::query()->where("page", "Home")->where("position", "Right")->order_by('created_at', 'desc')->limit(1)->offset($page_no)->get_one();
                        ?>
                          ...
                          <?php if(isset($page_left_banner)): ?>
                             <div id="banner-gitar">
                                <a href="<?php echo $page_left_banner->web_address; ?>" target="_blank"><?php echo Asset::img(Model_Banner::get_banner($page_left_banner),array("width" => "500", "height" => "216")) ?></a>
                                </div>
                             <?php endif; ?>
                        <?php if(isset( $page_right_banner)): ?>
                                <div id="banner-coca">
                                <a href="<?php echo  $page_right_banner->web_address; ?>" target="_blank"><?php echo Asset::img(Model_Banner::get_banner($page_right_banner),array("width" => "500", "height" => "216")) ?></a>
                    </div>
                        <?php endif; ?>
                        <div class="clearfix"></div>
                         </div>
    ...
    <div id="home-view-more">
        <p id = "view-more-anchor" class="white-btn" url = "<?php echo Uri::create('pages/home_show_more'); ?>" data-page-no="2">VIEW MORE VIDEOS
        </p>
    </div>
    <?php endif; ?>
  </div>
