<div id="center" class="clearfix">
    ...
    <div class="videokes-center content-box clearfix comments-videokes">
        <div class="vids">
            ...
            if (isset($videokes)) {
                ...
                if (sizeof($videokes) > 0) {
                    ...
                    echo "<p class='nodata-home-comments'>No Videos uploaded yet</p>";
                }
            } else {
                echo "<p class='nodata-home-comments'>No Videos uploaded yet";
            }
            ?>
             </div>
            <div class="clearfix"></div>
        ...
        <div class="comments">
            <div class="title">
                <p class="main-title">
                    <?php echo Asset::img("/home/commentsIcon.png"); ?>
                    MY COMMENTS
                </p>
                <hr class="divider" />
            </div>
            ...
            <div class="comment-inner" id="comment-<?php echo $comment->id?>">
                ...
                <div class="comment-reply-box" id="comment-div-<?php echo $comment->id;?>">
                    ...
                    <div class="pull-left reply-input">
                        <form class="comment-reply" id="comment-reply-<?php echo $comment->id;?>" action="<?php echo Uri::create('comments/replay') ?>" method="post">
            ...
            <hr class="comment-large-separator"/>
             ...
             <?php endforeach;?>
                ...
                <?php              
                		...
                		echo '<p class="nodata-home-comments">No comments to display!</p>';
               endif; ?>
    ...
    <div class="videokes-right content-box clearfix">
        ...
        ?>
        <p><a class="pull-right see-more-link" href="#"><span class="red"> &gt;</span> SEE MORE</a></p>
        <div class="clearfix"></div>
