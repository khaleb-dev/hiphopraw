                            ...
                            <li>
                                ...
                                <?php if($current_user->id != $user->id ){?>
                                    ...
                                    <form id="follower-request-form" action="<?php echo Uri::create('followers/create'); ?>" method="post">
                                        <input type="hidden" value="<?php echo $user->id;?>" name="receiver_id">
                    ...
                    <li class="active">
                            ...
                            <li>
                                <div>
                                    ...
                                    <button class="profile-follow-btn" id="public-button-follow"></button>
         ...
         <!--        <?php if ($current_user): ?>
            ...
            <div id="profile-videos-tab" class="profile-tabs">
                ...
                if ($videokes) {
                    ...
                    $count_videokes = sizeof($videokes);
                    ...
                    <?php if($i > 9) { ?>
                              <div class = "clearfix"></div>
                                    ...
                                    <div class="profile-view-more">
                                             <a id = "view-more-anchor"  url = "<?php echo Uri::create('users/show_more_videos'); ?>" data-page-no="2"><button class="white-btn">View More Videos</button></a>
                                     </div>
                            <?php break;?>
                  <?php  }
