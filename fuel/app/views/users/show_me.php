<div id="center" class="clearfix">
    ...
    <div id="content" class="with-sidebar-left profile">
        ...
        <div class="my-friends" class="content-box">
		 <div class="title">
                    <p class="pull-left middle-title-setting"><?php echo Html::anchor("users/my_followers", "MY FOLLOWERS"); ?>
                    </p>
                   
                    <p class="pull-left middle-title">| SHOW WHO I'M FOLLOWING
                    </p>
               ...
               ?>
                <p class = "no-message-data">you are not following any person!</p>
               <?php } ?>
			...
			<div class="back">
                ...
                <p class="back" style="float:left; margin-top:210px; margin-left:-110px;"><?php echo Html::anchor("#", "&gt; VIEW MORE"); ?></p>		
