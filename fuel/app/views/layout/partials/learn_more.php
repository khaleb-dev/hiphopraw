<div class="dialog login-sign-up-container" id="learn-more-new-pages" xmlns="http://www.w3.org/1999/html">
    <div id="title_bar">
        <span id="title-bar-left-text">Sign Up Nowww</span>
    ...
    <form action="<?php echo Uri::create('users/sign_up'); ?>" class="block-form with-boundary clearfix"
        ...
        <div class="half">
            ...
            <p class="choose-state">
                ...
                <input type="checkbox" name="fan" value="fan"><span class="fan"> check if you are not a hiphop artist or model.</span>
            </p>
