<div id="top-template-wrap">
  ...
  <div class="circle" style=" position: absolute; top:12px;"><a><?php if($header_new_comments){echo count($header_new_comments); } else { echo 0;} ?></a></div>
            ...
            ?>
              ...
              <div class="view-more" id = "url-holder" url = "<?php echo Uri::create('friendships/update')?>">
                 <p>
                  ...
                  <a href="<?php echo Uri::create('messages/index').'/'. Model_Message::INBOX .'/'. $current_user->id;?>" style="text-decoration:none;" >&or; View more Messages </a>
            </div>
          <?php
              break;
           }
