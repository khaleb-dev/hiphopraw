...
return array(
    ...
    'max_size' => 356*pow(2,20), //256MB

    // list of file extensions that a user is allowed to upload
    //'ext_whitelist' => array('png', 'jpeg', 'jpg', 'webm', 'ogg', 'mov', 'wmv', 'mp4'),
    ...
    'type_whitelist' => array("image", "audio", "video", "application"),
    ...
    'mime_whitelist' => array('image/png', 'image/jpeg', 'video/webm', 'application/ogg', 'video/ogg', 'video/quicktime', 'video/x-ms-wmv', 'video/mp4', 'video/x-flv'),
